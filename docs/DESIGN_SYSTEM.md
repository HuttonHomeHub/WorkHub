...
| **Alert**        | `role="alert"`, variants `default \| destructive \| info` (a soft fill with its `-text` colour and a leading icon), with `AlertTitle`/`AlertDescription`. Used for view- and form-level errors.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
